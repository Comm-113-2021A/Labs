...
Go to the course [GitHub organization](https://github.com/Comm-113-2021A) and locate your Lab 02 repo, which should be named `lab-02-plastic-waste-YOUR_GITHUB_USERNAME`.
...
Refer to [HW 01](https://comm-113-2021a.github.io/Slides/Lab01/hw-00-pet-names.html) if you would like to see step-by-step instructions for cloning a repo into an RStudio project.
...
<i> **Warm up 1:** Editor; Console; Environment, history, git; Files, plots, packages, help, viewer\
**Warm up 2:** 240\
